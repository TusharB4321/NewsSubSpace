...
import com.example.newssubspace.R
import com.example.newssubspace.Utils.DateFormat
import com.example.newssubspace.Utils.randomDrawbleColor
import com.example.newssubspace.model.Articles

class RvAdapter// this.itemClickListener= (OnItemClickListener) context;
// this.itemClickListener=onItemClickListener;
// static Context context
// public OnItemClickListener itemClickListener;
    (var articles: List<Articles>, var context: Context) : RecyclerView.Adapter<RvAdapter.MyViewHolder>() {
...
//            context.startActivity(intent)
            Toast.makeText(context, "Feature is working", Toast.LENGTH_SHORT).show()
